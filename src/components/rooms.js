...
/*<div className="max-w-[1400px] h-[300px] bg-blue-100 mx-auto my-20 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid">
	<div className=" relative lg:col-span-1 col-span-2">
		<h3>Fine Interior Rooms</h3>
		<p className="pt-4 ">
			Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc de hominis
			summo bono quaeritur.
		</p>
	</div>
	<div className="  grid grid-cols-2 col-span-2 gap-2 md:flex-wrap">
		<img
			className=" object-cover w-full h-25"
			src="https://images.unsplash.com/photo-1507038772120-7fff76f79d79?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
			alt="/"
		/>
		<img
			className="row-span-2 object-cover w-full h-25"
		...
		<img
			className="object-cover w-full h-25"
			src="https://images.unsplash.com/photo-1590490359683-658d3d23f972?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
			alt="/"
		/>
	</div>
</div>*/
